...
* item[2].linkId = "grp-family-history"
* item[2].item[0].linkId = "family-hx-prostate"
* item[2].item[0].answer.valueCoding = $sct#373067005 "No (qualifier value)"
* item[2].item[1].linkId = "family-hx-breast"
* item[2].item[1].answer.valueCoding = $sct#261665006 "Unknown (qualifier value)"
* item[2].item[2].linkId = "family-hx-ovarian"
* item[2].item[2].answer.valueCoding = $sct#373067005 "No (qualifier value)"
* item[2].item[3].linkId = "family-hx-colon"
* item[2].item[3].answer.valueCoding = $sct#373067005 "No (qualifier value)"
