...
* valueCodeableConcept = PreciseCategoryLtProstateCS#precise-3 "PRECISE 3 - Stable disease"
* derivedFrom[+] = Reference(imagingstudy-prostate-mpmri-example)
* component[newLesion].valueBoolean = false
* component[changePattern].valueCodeableConcept = PreciseChangePatternLtProstateCS#local "Local change"
...
* derivedFrom[+] = Reference(imagingstudy-prostate-mpmri-example)
* valueCodeableConcept = PreciseCategoryLtProstateCS#precise-4 "PRECISE 4 - Likely progression"
* component[newLesion].valueBoolean = false
* component[changePattern].valueCodeableConcept = PreciseChangePatternLtProstateCS#local "Local change"
* component[bestSequence].valueCodeableConcept = $dicom-dcm#113043 "Diffusion weighted"
