...
// EU base and core profiles
// Based on the https://hl7.eu/fhir/base-r5/0.1.0/
Alias: $EuAddress              = AddressEu
...
// EU Imaging profiles
// Based on the https://hl7.eu/fhir/imaging-r5/
...
Alias: $EuComposition           = CompositionEu
Alias: $EuCompositionUrl        = http://hl7.eu/fhir/imaging-r5/StructureDefinition/CompositionEu
